...
export class PathGeneratorPanel {
    ...
    private _getHtmlForWebview(webview: vscode.Webview) {
        ...
        const js = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, 'media', 'path-generator', 'path-generator.js'));
...
<body oncontextmenu="return false;">
    ...
    <script nonce="${nonce}" src="${js}" data-img-src="${fieldImg}"></script>
</body>
</html>
`;
    }
